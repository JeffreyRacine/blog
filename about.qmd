...
about:
  ...
  links:
    - icon: journal-text
      ...
      href: https://jeffreyracine.github.io/research/
    - icon: code-square
      text: Gallery of Code
      href: https://jeffreyracine.github.io/gallery/
    - icon: file-earmark-person
      text: CV
      href: https://jeffreyracine.github.io/vitae/
    - icon: github
      text: Public GitHub Repositories
      href: https://github.com/JeffreyRacine
---

This website exists to encourage discussion about any manner of things, academic or otherwise. If this site has a bias, it is likely towards open and free computing technology that streamlines workflow, particularly tools for pursuing reproducible research. One difference between this site and my [research website](https://jeffreyracine.github.io/research/) is the presence of a blog that presents a forum for further discussion in the public sphere.

If you are searching for working papers, information about R packages or textbooks that I have authored, a current curriculum vitae, course information and the like, kindly visit my [research website](https://jeffreyracine.github.io/research/), [gallery of code](https://jeffreyracine.github.io/gallery/), or [CV](https://jeffreyracine.github.io/vitae/). My [McMaster profile](https://experts.mcmaster.ca/display/racinej) remains available as the institutional profile.
...
I served as an Associate Editor for the journal [*Econometric Reviews*](https://www.tandfonline.com/loi/lecr20) from 2012 to 2025.

...
image-alt: "Static website and blogdown graphic"
categories:
  - Computing
  - Open Web
---
...
This site was created using blogdown, and at the time I made the original Hugo source available through GitHub. The current source now lives in the [Quarto blog repository](https://github.com/JeffreyRacine/blog). I found the [blogdown tutorial](https://notes.peter-baumgartner.net) by Peter Baumgartner to be most valuable. By following his instructions I was up and running in no time.
